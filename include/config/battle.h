...
#define B_ILLUSION_WILD             GEN_LATEST // In Gen9+, wild Pokémon with the ability Illusion enter battle disguised as a random species that can appear in the area that it's found in.
